...
{
    public partial class SetmisFile200Extracted
    {
        public long Id { get; set; }
        public string? Countrycode { get; set; }
        public DateTime? CreateDate { get; set; }
        public string? Datestampstring { get; set; }
        public string? Employerapprovalstatusenddate { get; set; }
        public string? Employerapprovalstatusidstring { get; set; }
        public string? Employerapprovalstatusnum { get; set; }
        public string? Employerapprovalstatusstartdatestring { get; set; }
        ...
        public string? Setaidstring { get; set; }
