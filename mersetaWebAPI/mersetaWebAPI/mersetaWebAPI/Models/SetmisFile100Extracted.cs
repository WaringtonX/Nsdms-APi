...
{
    public partial class SetmisFile100Extracted
    {
        ...
        public string? Latitudedegreestring { get; set; }
        public string? Latitudeminutesstring { get; set; }
        public string? Latitudesecondsstring { get; set; }
        public string? LineNumber { get; set; }
        public string? Longitudedegreestring { get; set; }
        public string? Longitudeminutesstring { get; set; }
        public string? Longitudesecondsstring { get; set; }
        ...
        public string? Providerenddatestring { get; set; }
        ...
        public string? Providerstartdatestring { get; set; }
