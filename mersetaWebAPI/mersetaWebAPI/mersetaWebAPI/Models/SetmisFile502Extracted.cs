...
{
    public partial class SetmisFile502Extracted
    {
        public long Id { get; set; }
        public string? Nonnqfintervcode { get; set; }
        ...
        public string? Cumulativespending { get; set; }
        public string? Datestampstring { get; set; }
        public string? Economicstatusid { get; set; }
        public string? Enrolmentdatestring { get; set; }
        public string? Enrolmentstatusdatestring { get; set; }
        ...
        public string? Mostrecentregistrationdatestring { get; set; }
        public string? Nationalid { get; set; }
        public string? Nonnqfintervetqeid { get; set; }
        ...
        public string? Urbanruralid { get; set; }
    }
}
