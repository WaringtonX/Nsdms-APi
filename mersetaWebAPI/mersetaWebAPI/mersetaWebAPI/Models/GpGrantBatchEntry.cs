...
{
    public partial class GpGrantBatchEntry
    {
        ...
        public virtual GpGrantBatchList GpGrantBatchList { get; set; } = null!;
        public virtual SarsEmployerDetail? SarsEmployerDetailLinked { get; set; }
        public virtual SarsLevyDetail? SarsLevyDetails { get; set; }
        public virtual User? UserActioned { get; set; }
    }
}
