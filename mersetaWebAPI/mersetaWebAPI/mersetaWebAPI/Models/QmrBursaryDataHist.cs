...
{
    public partial class QmrBursaryDataHist
    {
        ...
        public string? DescriptionOfTheQualification { get; set; }
        ...
        public ulong? NewBursaryIdentified { get; set; }
        public string? NewContinuingBursary { get; set; }
